...
Most of these come down to network reality or how vndirect serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

vndirect rate-limits like any public site. vndirect already paces
...
Where a surface is gated, vndirect reads a cookie or token you supply
...
`vndirect`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what vndirect actually did
